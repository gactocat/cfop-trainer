...
import type { OLLAlgorithmRecord } from '@/types/oll';
import type { Auf } from '@/types/pll';

interface OLLAlgorithmRowProps {
  record: OLLAlgorithmRecord;
...
export function OLLAlgorithmRow({
  record,
  onUpdate,
  onSetStar,
  onRemove,
      ...
      <div className="p-3">
        ...
        <div className="flex items-start gap-3">
          <button
            ...
            aria-label={record.isStarred ? t('algRow.starredOnlyOneOll') : t('algRow.setAsStarred')}
            title={record.isStarred ? t('algRow.starredShownOnOllGrid') : t('algRow.setAsStarred')}
          >
            ★
          </button>
